...
const resources = {
        ...
        translation: {
            landing: {
                hero: {
                    ...
                    subtitle:
                        'Freia brings together chatflows, agents, datasets, evaluations, vector stores, tools and more in one cohesive UI.',
            ...
            tools: {
                ...
                javascriptFunctionTooltip:
                    'Function to execute when tool is being used. You can use properties specified in Input Schema as variables. For example, if the property is userid, you can use as $userid. Return value must be a string.'
            },
            users: {
    ...
    es: {
        translation: {
            landing: {
                hero: {
                    ...
                    subtitle:
                        'Freia reúne chatflows, agentes, datasets, evaluaciones, almacenes vectoriales, herramientas y más en una sola interfaz.',
            ...
            tools: {
                ...
                javascriptFunctionTooltip:
                    'Función a ejecutar cuando se usa la herramienta. Puedes usar propiedades del esquema de entrada como variables (ej. $userid). El valor de retorno debe ser una cadena.'
            },
            users: {
        ...
        variables: {
            ...
            howToUseText1:
                'Las variables se pueden usar en Herramienta Personalizada, Función Personalizada, Cargador Personalizado, Función If Else con el prefijo $.',
            howToUseText2:
                'Las variables también se pueden usar en el parámetro Campo de Texto de cualquier nodo. Por ejemplo, en Mensaje del Sistema del Agente:',
            howToUseText3:
                'Si el tipo de variable es Estático, el valor se recuperará tal como está. Si el tipo de variable es Tiempo de Ejecución, el valor se recuperará del archivo .env.',
