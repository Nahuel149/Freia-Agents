...
const DocumentStoreSelector = ({ open, onClose, onSelect }) => {
                                ...
                                secondary={
                                    <Box>
                                        ...
                                        <Chip 
                                            label={loader.status} 
                                            size="small" 
                                            color={loader.status === 'SYNC' ? 'success' : 'default'}
                                        />
                                    </Box>
                                }
                            />
    ...
    const renderQueryInput = () => (
        <Box>
            ...
            <Typography variant="body2" color="textSecondary" sx={{ mb: 2 }}>
                Describe what you're looking for in the documents
            </Typography>
        ...
        if (step === 1) {
            ...
            actions.push(
                <Button 
                    key="next" 
                    onClick={handleNext}
                    disabled={selectedLoaders.length === 0}
                    variant="contained"
                >
                    Next
                </Button>
    ...
    return (
        ...
        >
            <DialogTitle>
                Document Store Integration - Step {step} of 3
            </DialogTitle>
            <DialogContent>
